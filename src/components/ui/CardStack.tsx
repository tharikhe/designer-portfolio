...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="relative h-full w-full bg-gray-900 border border-gray-800 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {item.videoSrc ? (
          ...
          <div className="flex h-full w-full flex-col items-center justify-center bg-zinc-900 text-zinc-500">
            ...
            <p className="font-mono text-lg font-bold tracking-wider">VIDEO {item.id}</p>
      ...
      {/* content */}
      <div className="relative z-10 flex h-full flex-col justify-end p-5 w-full">
