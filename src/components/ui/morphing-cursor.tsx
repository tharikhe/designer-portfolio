...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
    ...
    return (
        <div
            ...
            className={cn("relative inline-flex items-center justify-center cursor-none select-none p-4", className)} // Added p-4 for hit area
        >
            ...
            <div
                ref={circleRef}
                className="absolute top-0 left-0 pointer-events-none rounded-full bg-red overflow-hidden z-50" // changed bg-foreground to bg-red for visibility request matches site theme
                style={{
            ...
            >
                ...
                >
                    <span className="text-5xl font-bold tracking-tighter text-cream whitespace-nowrap tracking-wide">
                        {hoverText}
                    </span>
                </div>
            </div>
