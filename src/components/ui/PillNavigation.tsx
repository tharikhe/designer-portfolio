...
export const PillNavigation: React.FC = () => {
    ...
    const navItems: NavItem[] = [
        ...
        { label: 'Work', id: 'work', href: '#social-media' },
                ...
                {expanded && (
                    <div className="flex items-center justify-evenly w-full">
                            ...
                            return (
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        color: isActive ? '#C41E3A' : '#656565', // Red for active
                                        textDecoration: 'none',
                                        letterSpacing: '0.45px',
                      ...
                      `,
                                    ...
                                    onMouseEnter={(e) => {
                                        if (!isActive) {
                                            e.currentTarget.style.color = '#A01830' // Red dark on hover
